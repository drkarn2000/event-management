  ...
  return (
    <main className="overflow-hidden bg-[#f7f4ee] text-[#101b24]">
      <section className="relative min-h-[58vh] overflow-hidden bg-[#071119] text-white">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#071119]/88 via-[#071119]/44 to-[#071119]/10" />
        <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[#f7f4ee] to-transparent" />
        <div className="relative mx-auto flex min-h-[58vh] max-w-[1440px] flex-col justify-end px-5 pb-14 pt-32 md:px-12">
          <motion.div {...reveal}>
            <p className="text-xs font-black uppercase tracking-[0.55em] text-white/80">Events around the world</p>
            <h1 className="mt-5 max-w-3xl text-6xl font-black leading-[0.9] tracking-tight md:text-8xl">
